...
add wave -noupdate /tb_top/master_if/clk
add wave -noupdate /tb_top/master_if/data_req_i
add wave -noupdate /tb_top/master_if/data_add_i
add wave -noupdate /tb_top/master_if/data_wen_i
add wave -noupdate /tb_top/master_if/data_wdata_i
add wave -noupdate /tb_top/master_if/data_be_i
add wave -noupdate /tb_top/master_if/data_gnt_o
add wave -noupdate /tb_top/master_if/data_r_valid_o
add wave -noupdate /tb_top/master_if/data_r_rdata_o
add wave -noupdate /tb_top/slave_if/clk
add wave -noupdate /tb_top/slave_if/data_req_o
add wave -noupdate /tb_top/slave_if/data_add_o
add wave -noupdate /tb_top/slave_if/data_wen_o
add wave -noupdate /tb_top/slave_if/data_wdata_o
add wave -noupdate /tb_top/slave_if/data_be_o
add wave -noupdate /tb_top/slave_if/data_ID_o
add wave -noupdate /tb_top/slave_if/data_r_rdata_i
add wave -noupdate /tb_top/slave_if/data_r_valid_i
add wave -noupdate /tb_top/slave_if/data_r_ID_i
